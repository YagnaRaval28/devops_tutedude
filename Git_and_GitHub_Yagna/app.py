...
Home page and an /api route backed by data/courses.json, the To-Do page
merged from master_1, and the /submittodoitem endpoint merged from
master_2 which stores items in MongoDB.
"""
